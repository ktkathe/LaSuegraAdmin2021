...
@section('content') 
    ...
    <form enctype="multipart/form-data" action="{{ route('subirPromo1.store') }}" method="POST">
    ...
    <div class="row">
         <div class="col-xs-12 col-sm-12 col-md-12">    
            <h3 style="color:#000033; margin-bottom: 5%; text-align: center;font-weight: bold">¡Subir Imagen principal del Patrocinador Platino!</h3>
         </div>
