...
@section('content') 
    ...
    <form enctype="multipart/form-data" action="{{ route('grupo1.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <h3 style="color:#000033; margin-bottom: 5%; text-align: center;font-weight: bold">¡Crear Grupo Suegreros Blue!</h3>
        </div>
         <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group">
               <label style=" font-family: inherit;
                font-weight: bold;
                color: #000033; padding-bottom: 3%;" >Seleccionar Suegreros Blue:</label>
